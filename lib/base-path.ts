 ...
 *
 * Example: If deployed at https://example.com/openbimforge, this returns "/openbimforge"
 * For root deployment, this returns ""
 *
 * Set NEXT_PUBLIC_BASE_PATH environment variable to your subdirectory path (e.g., /openbimforge)
 */
 ...
 * @param assetPath - Asset path (e.g., "/architecture.png", "/favicon.ico")
